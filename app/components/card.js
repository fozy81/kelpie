...
export default class CardComponent extends Component {
    ...
    restore(id) {           
        if(id.type === 'form') {
        let form = this.store.peekRecord('form', id.id, { include: 'form.questions' })
        ...
        let task = this.store.peekRecord('task', id.id, { include: 'forms.questions' })
        ...
        let project = this.store.peekRecord('project', id.id, { include: 'tasks.forms.questions' })
